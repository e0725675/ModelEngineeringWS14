 ...
 * <ul>
 *   <li>{@link at.ac.tuwien.big.forms.impl.TextFieldImpl#getFormat <em>Format</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TextFieldImpl extends AttributePageElementImpl implements TextField {
	...
	protected EClass eStaticClass() {
		return FormsPackage.Literals.TEXT_FIELD;
	}
	...
	public void setFormat(String newFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormsPackage.TEXT_FIELD__FORMAT, oldFormat, format));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FormsPackage.TEXT_FIELD__FORMAT:
				return getFormat();
		}
