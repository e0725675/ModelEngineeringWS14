 ...
 * <ul>
 *   <li>{@link at.ac.tuwien.big.forms.impl.PageImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link at.ac.tuwien.big.forms.impl.PageImpl#getPageElements <em>Page Elements</em>}</li>
 *   <li>{@link at.ac.tuwien.big.forms.impl.PageImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PageImpl extends MinimalEObjectImpl.Container implements Page {
	...
	public EList<PageElement> getPageElements() {
		if (pageElements == null) {
			pageElements = new EObjectContainmentEList<PageElement>(PageElement.class, this, FormsPackage.PAGE__PAGE_ELEMENTS);
		}
		return pageElements;
	}
	...
	public NotificationChain basicSetCondition(Condition newCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormsPackage.PAGE__CONDITION, oldCondition, newCondition);
	...
	public void setCondition(Condition newCondition) {
		if (newCondition != condition) {
			...
			if (condition != null)
				msgs = ((InternalEObject)condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FormsPackage.PAGE__CONDITION, null, msgs);
			if (newCondition != null)
				msgs = ((InternalEObject)newCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FormsPackage.PAGE__CONDITION, null, msgs);
			msgs = basicSetCondition(newCondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormsPackage.PAGE__CONDITION, newCondition, newCondition));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FormsPackage.PAGE__CONDITION:
