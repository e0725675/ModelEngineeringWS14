...
public class FormsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FormsPackage.ATTRIBUTE_TYPES: {
				AttributeTypes attributeTypes = (AttributeTypes)theEObject;
				T result = caseAttributeTypes(attributeTypes);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FormsPackage.PUBLICATION_VENUE: {
				PublicationVenue publicationVenue = (PublicationVenue)theEObject;
				T result = casePublicationVenue(publicationVenue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Publication Venue</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Publication Venue</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePublicationVenue(PublicationVenue object) {
		return null;
	}
