...
public class FormsAdapterFactory extends AdapterFactoryImpl {
	...
	protected FormsSwitch<Adapter> modelSwitch =
		new FormsSwitch<Adapter>() {
			...
			@Override
			public Adapter casePublicationVenue(PublicationVenue object) {
				return createPublicationVenueAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link forms.AttributeTypes <em>Attribute Types</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link forms.PublicationVenue <em>Publication Venue</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPublicationVenueAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link forms.Id <em>Id</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
