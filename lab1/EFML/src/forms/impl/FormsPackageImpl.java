...
public class FormsPackageImpl extends EPackageImpl implements FormsPackage {
	 ...
	 * @generated
	 */
	private EClass publicationVenueEClass = null;
	 ...
	 * @generated
	 */
	public EReference getEntity_EntityAttribute() {
	 ...
	 * @generated
	 */
	public EAttribute getAttributeTypes_String() {
		return (EAttribute)attributeTypesEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getAttributeTypes_Type() {
		return (EAttribute)attributeTypesEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getPublicationVenue() {
		return publicationVenueEClass;
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(attributeTypesEClass, ATTRIBUTE_TYPES__STRING);
		createEAttribute(attributeTypesEClass, ATTRIBUTE_TYPES__TYPE);

		publicationVenueEClass = createEClass(PUBLICATION_VENUE);
	...
	public void initializePackageContents() {
		...
		idEClass.getESuperTypes().add(this.getAttribute());

		// Initialize classes, features, and operations; add parameters
		initEClass(entityEClass, Entity.class, "Entity", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEntity_EntityAttribute(), this.getAttribute(), null, "entityAttribute", null, 0, -1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEntity_EntityID(), this.getId(), null, "entityID", null, 1, 1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(attributeTypesEClass, AttributeTypes.class, "AttributeTypes", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAttributeTypes_String(), ecorePackage.getEBoolean(), "String", null, 1, 1, AttributeTypes.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAttributeTypes_Type(), ecorePackage.getEString(), "type", null, 0, -1, AttributeTypes.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(publicationVenueEClass, PublicationVenue.class, "PublicationVenue", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEAttribute(getAttribute_Mandatory(), theXMLTypePackage.getBoolean(), "mandatory", null, 1, 1, Attribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
